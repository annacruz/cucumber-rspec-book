...
Funcionalidade: Fim do jogo
  ...
  Contexto:
    * o jogo tem as possiveis palavras para sortear:
      | número de letras | palavra sorteada |
      | 3                | avo              |

  Cenário: Jogador vence o jogo
    Para que o jogador possa vencer o jogo, ele precisa adivinhar todas as
    letras do jogo antes que todas as partes do boneco da forca apareçam.
  ...
  Cenário: Jogador perde o jogo
    Para que o jogador perca o jogo, basta que ele erre 6 vezes ao tentar
    adivinhar uma letra.
